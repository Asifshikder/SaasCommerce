...
public class BaseDbContext(IMultiTenantContextAccessor<ApplicationTenantInfo> multiTenantContextAccessor,
    ...
    : MultiTenantDbContext(multiTenantContextAccessor, options)
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.ConfigureDatabase(multiTenantContextAccessor.MultiTenantContext.TenantInfo.ConnectionString!);
        }
    }
