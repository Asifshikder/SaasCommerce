...
using Project.Infrastructure.Tenant.Abstractions;
using Project.Shared.Authorization;

namespace Project.Infrastructure.Tenant;
public sealed class ApplicationTenantInfo : IApplicationTenantInfo
{
    ...
    string? IApplicationTenantInfo.ConnectionString { get => ConnectionString; set => ConnectionString = value ?? throw new InvalidOperationException("ConnectionString can't be null."); }
}
